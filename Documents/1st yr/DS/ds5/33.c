...
node *rotate(node *tree,int num)
{
	...
	if(num<tree->data)
	{
		if(tree->left !=NULL)
		{
			...
			else if(tree->left->left!=NULL && tree->left->left->data==num)
			{
				tree->left=singleleft(tree->left);
				tree=singleleft(tree);
			}
			else if(tree->left->right!=NULL && tree->left->right->data==num)
			{
	...
	else if(num>tree->right->data)
	{
		if(tree->right!=NULL)
		{
			...
			else if(tree->right->left!=NULL && tree->right->left->data==num)
			{
				tree->right=singleleft(tree->right);
				tree=singleright(tree);
			}
			else if(tree->right->right!=NULL && tree->right->right->data==num)
			{
