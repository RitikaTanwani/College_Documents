...
\begin{equation}
\sum_{\substack{i=1}}^{\superstack{n}}a_i\geq\sqrt[n]{{\prod_{\substack{i=1}}^{\superstack{n}}}a_i}  ,~~~\forall a \in {\mathbf{R}_{+}}
\end{equation}
...
\end{equation}
\begin{equation}
\mathbf{S}=\left{x|x \geq 0,x\in \mathbf{Z}\right}
\end{equation}
...
\end{equation}
\begin{equation}
\int \limits_{0}^{n}\!\int \limits_n^{\infty}(x^3+y^2)dx.dy
\end{equation}
\begin{center}
\begin{equation}
 A_{m,n} =
